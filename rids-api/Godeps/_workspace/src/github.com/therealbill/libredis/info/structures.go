...
// InfoCluster represents the Cluster section of Redis INFO beginning w/Redis
// 3.0
type InfoCluster struct {
	Enabled bool `redis:"cluster_enabled"`
}
...
//InfoPersistence reprsents the Persistence section of Redis INFO
...
type RedisInfoAll struct {
	...
	Cluster      InfoCluster      `section:"cluster"`
}
