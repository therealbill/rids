...
// GetAllInfo retuns a RedisInfoAll struct. This struct has as it's members a
// struct for each INFO section. Since the cost difference of running INFO all
// and INFO <section> is negligible it makes sense to just return it all and let
